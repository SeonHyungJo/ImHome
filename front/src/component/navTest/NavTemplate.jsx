...
class NavTemplate extends Component {
    ...
    render() {
        ...
        const isCompany =
            navList && navList[0] && navList[0].hasOwnProperty('companyCode') ? true : false;
        return (
            <>
                <NavContainer>
                    {/* 1-2 */}
                        ...
                        ? navList.map((data, index) => {
                              return data.companyCode === currentNav ? (
                                  <li
                                      ...
                                      id={data.companyCode}
                                      onClick={() =>
                                          this.props.clickNav && this.clickNavItem(data.companyCode)
                                      }
                                  >
                                      {data.companyName}
                                  </li>
                        ...
                        : navList.map((data, index) => {
                              return data.branchCode === currentNav ? (
                                  <li
                                      ...
                                      id={data.branchCode}
                                      onClick={() =>
                                          this.props.clickNav && this.clickNavItem(data.branchCode)
                                      }
                                  >
                                      {data.branchName}
                                  </li>
