...
import {
  UserRegister, UserMain, UserOrderList, UserProduct, UserReleaseList,
} from './pages/user';
import {
  AdminMain,
  AdminUser,
          ...
          <>
            {this.state.admin ? (
              <>
                ...
                <Route exact component={AdminMain} path={ADMIN_PATH} />
              ...
              <>
                {/* Register router : 회원가입 */}
                <Route exact component={UserRegister} path="/register" />

                {/* User router : 사용자 라우터 */}
                <Route exact component={UserMain} path="/main" />
